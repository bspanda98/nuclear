...
# 1. install nuclear for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for nuclear
# 5. create nuclear, attach and uninstall start menu entries
...
!define GROUPNAME "Nuclear"
!define APPNAME "Nuclear Gen 3"
!define DESCRIPTION "Official Go implementation of the Nuclear Gen 3 protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since nuclear is installed global
