Name "Nuclear ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://www.nuclear/contact-us/"
...
Section "Gen 3 Core Node" GETH_IDX
  ...
  createShortCut "$SMPROGRAMS\${APPNAME}\Core Node.lnk" "$INSTDIR\nuclear.exe" "--cache=512"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\nuclear.exe" "attach \\.\pipe\nuclear.ipc" "" ""
  createShortCut "$SMPROGRAMS\${APPNAME}\Testnet Core Node.lnk" "$INSTDIR\nuclear.exe" "--testnet --cache=512 -ipcpath test-nuclear.ipc"
  createShortCut "$SMPROGRAMS\${APPNAME}\Testnet Attach.lnk" "$INSTDIR\nuclear.exe" "--testnet attach \\.\pipe\test-nuclear.ipc" "" ""
  createShortCut "$SMPROGRAMS\${APPNAME}\Uninstall.lnk" "$INSTDIR\uninstall.exe" "" "" ""

  # Firewall - remove rules (if exists)
  SimpleFC::AdvRemoveRule "Nuclear Gen 3 incoming peers (TCP:39797)"
  SimpleFC::AdvRemoveRule "Nuclear Gen 3 outgoing peers (TCP:39797)"
  SimpleFC::AdvRemoveRule "Nuclear Gen 3 UDP discovery (UDP:39797)"
  SimpleFC::AdvRemoveRule "Nuclear Gen 3 Testnet incoming peers (TCP:49797)"
  SimpleFC::AdvRemoveRule "Nuclear Gen 3 Testnet outgoing peers (TCP:49797)"
  SimpleFC::AdvRemoveRule "Nuclear Gen 3 Testnet UDP discovery (UDP:49797)"


  # Firewall - add rules
  SimpleFC::AdvAddRule "Nuclear Gen 3 incoming peers (TCP:39797)" ""  6 1 1 2147483647 1 "$INSTDIR\nuclear.exe" "" "" "Nuclear" 39797 "" "" ""
  SimpleFC::AdvAddRule "Nuclear Gen 3 outgoing peers (TCP:39797)" ""  6 2 1 2147483647 1 "$INSTDIR\nuclear.exe" "" "" "Nuclear" "" 39797 "" ""
  SimpleFC::AdvAddRule "Nuclear Gen 3 UDP discovery (UDP:39797)" "" 17 2 1 2147483647 1 "$INSTDIR\nuclear.exe" "" "" "Nuclear" "" 39797 "" ""
  SimpleFC::AdvAddRule "Nuclear Gen 3 Testnet incoming peers (TCP:49797)" ""  6 1 1 2147483647 1 "$INSTDIR\nuclear.exe" "" "" "Nuclear" 49797 "" "" ""
  SimpleFC::AdvAddRule "Nuclear Gen 3 Testnet outgoing peers (TCP:49797)" ""  6 2 1 2147483647 1 "$INSTDIR\nuclear.exe" "" "" "Nuclear" "" 49797 "" ""
  SimpleFC::AdvAddRule "Nuclear Gen 3 Testnet UDP discovery (UDP:49797)" "" 17 2 1 2147483647 1 "$INSTDIR\nuclear.exe" "" "" "Nuclear" "" 49797 "" ""

  # Set default IPC endpoint (https://github.com/ethereum/EIPs/issues/147)
  ${EnvVarUpdate} $0 "ENERGI3_SOCKET" "R" "HKLM" "\\.\pipe\nuclear.ipc"
  ${EnvVarUpdate} $0 "ENERGI3_SOCKET" "A" "HKLM" "\\.\pipe\nuclear.ipc"
  ${EnvVarUpdate} $0 "ENERGI3_TESTNET_SOCKET" "R" "HKLM" "\\.\pipe\test-nuclear.ipc"
  ${EnvVarUpdate} $0 "ENERGI3_TESTNET_SOCKET" "A" "HKLM" "\\.\pipe\test-nuclear.ipc"
