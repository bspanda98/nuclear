...
import (
	...
	"nuclear/core/nuclear/common/compiler"
)

var (
	abiFlag = flag.String("abi", "", "Path to the Nuclear contract ABI json to bind, - for STDIN")
	binFlag = flag.String("bin", "", "Path to the Nuclear contract bytecode (generate deploy method)")
	runFlag = flag.String("runbin", "", "Path to the Nuclear contract runtimecode (generate runtime method)")
	typFlag = flag.String("type", "", "Struct name for the binding (default = package name)")

	solFlag  = flag.String("sol", "", "Path to the Nuclear contract Solidity source to build and bind")
