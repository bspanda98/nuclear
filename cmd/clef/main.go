...
import (
	...
	"nuclear/core/nuclear/signer/core"
	"nuclear/core/nuclear/signer/rules"
	"nuclear/core/nuclear/signer/storage"
...
func init() {
	app.Name = "Clef"
	app.Usage = "Manage Nuclear account operations"
	app.Flags = []cli.Flag{
		logLevelFlag,
		keystoreFlag,
		configdirFlag,
...
func DefaultConfigDir() string {
	...
	if home != "" {
		if runtime.GOOS == "darwin" {
			return filepath.Join(home, "Library", "NuclearSigner")
		} else if runtime.GOOS == "windows" {
			return filepath.Join(home, "AppData", "Roaming", "NuclearSigner")
		} else {
