...
var (
	...
	netFlag     = flag.Uint64("network", 0, "Network ID to use for the Nuclear protocol")
	...
	logFlag    = flag.Int("loglevel", 3, "Log level to use for Nuclear and the faucet")
)
...
func (f *faucet) apiHandler(conn *websocket.Conn) {
	...
	for {
		...
		default:
			err = errors.New("Something funky happened, please open an issue at https://nuclear/core/nuclear/issues")
		}
		if err != nil {
			if err = sendError(conn, err); err != nil {
...
func authTwitter(url string) (string, string, common.Address, error) {
	...
	if address == (common.Address{}) {
		return "", "", common.Address{}, errors.New("No Nuclear address found to fund")
	}
	var avatar string
