...
const (
	clientIdentifier = "nuclear" // Client identifier to advertise over the network
)
...
var (
	...
	app = utils.NewApp(gitCommit, "the Nuclear Core command line interface")
...
func startNode(ctx *cli.Context, stack *node.Node) {
	...
	if ctx.GlobalBool(utils.MiningEnabledFlag.Name) ||
		...
		if err := stack.Service(&ethereum); err != nil {
			utils.Fatalf("Nuclear service not running: %v", err)
		}
