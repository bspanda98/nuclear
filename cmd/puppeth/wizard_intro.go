...
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your Nuclear private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new Nuclear network down to  |")
	...
	log.Info("Administering Nuclear network", "name", w.network)
