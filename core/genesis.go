// Copyright 2018 The Nuclear Core Authors
...
import (
	...
	"nuclear/core/nuclear/common/hexutil"
	"nuclear/core/nuclear/common/math"
	"nuclear/core/nuclear/core/rawdb"
...
func (g *Genesis) configOrDefault(ghash common.Hash) *params.ChainConfig {
	...
	case ghash == params.MainnetGenesisHash:
		return params.NuclearMainnetChainConfig
	case ghash == params.TestnetGenesisHash:
		return params.NuclearTestnetChainConfig
	default:
...
func (g *Genesis) ToBlock(db ethdb.Database) *types.Block {
	...
	if config := g.Config; config != nil {
		debug := false
		author := energi_params.Nuclear_TreasuryV1
...
func DefaultNuclearMainnetGenesisBlock() *Genesis {
	return &Genesis{
		Config:     params.NuclearMainnetChainConfig,
		Coinbase:   energi_params.Nuclear_Treasury,
		Nonce:      0,
		...
		Xfers:      DeployNuclearGovernance(params.NuclearMainnetChainConfig),
	}
}

func DefaultNuclearTestnetGenesisBlock() *Genesis {
	...
	return &Genesis{
		...
		Difficulty: big.NewInt(0xFFFF),
		Alloc:      DefaultPrealloc(),
		Xfers:      DeployNuclearGovernance(params.NuclearTestnetChainConfig),
	}
}

// DeveloperNuclearGenesisBlock scans the custom genesis block from the provided
// file path.
func DeveloperNuclearGenesisBlock(customGenesisPath string) (*Genesis, error) {
	...
	genesis.Xfers = append(genesis.Xfers, DeployNuclearGovernance(genesis.Config)...)
	return genesis, nil
}
...
func DeployNuclearGovernance(config *params.ChainConfig) GenesisXfers {
	...
	deployNuclearContract(
		&xfers,
		energi_params.Nuclear_BlockRewardV1,
		nil,
		energi_abi.BlockRewardV1ABI,
		energi_abi.BlockRewardV1Bin,
		energi_params.Nuclear_BlockReward,
		[4]common.Address{
			energi_params.Nuclear_StakerReward,
			energi_params.Nuclear_BackboneReward,
			energi_params.Nuclear_Treasury,
			energi_params.Nuclear_MasternodeRegistry,
		},
	)
	deployNuclearContract(
		&xfers,
		energi_params.Nuclear_TreasuryV1,
		nil,
	...
	deployNuclearContract(
		&xfers,
		energi_params.Nuclear_StakerRewardV1,
		nil,
	...
	deployNuclearContract(
		&xfers,
		energi_params.Nuclear_BackboneRewardV1,
		nil,
		energi_abi.BackboneRewardV1ABI,
		energi_abi.BackboneRewardV1Bin,
		energi_params.Nuclear_BackboneReward,
		config.Nuclear.BackboneAddress,
	)
	if ver > 1 {
		deployNuclearContract(
			&xfers,
			energi_params.Nuclear_SporkRegistryV1,
			nil,
			energi_abi.SporkRegistryV2ABI,
			energi_abi.SporkRegistryV2Bin,
			energi_params.Nuclear_SporkRegistry,
			energi_params.Nuclear_MasternodeRegistry,
			config.Nuclear.CPPSigner,
		)
		deployNuclearContract(
			&xfers,
			energi_params.Nuclear_CheckpointRegistryV1,
			nil,
			energi_abi.CheckpointRegistryV2ABI,
			energi_abi.CheckpointRegistryV2Bin,
			energi_params.Nuclear_CheckpointRegistry,
			energi_params.Nuclear_MasternodeRegistry,
			config.Nuclear.CPPSigner,
		)
		deployNuclearContract(
			&xfers,
			energi_params.Nuclear_MasternodeTokenV1,
			nil,
			energi_abi.MasternodeTokenV2ABI,
			energi_abi.MasternodeTokenV2Bin,
			energi_params.Nuclear_MasternodeToken,
			energi_params.Nuclear_MasternodeRegistry,
		)
		deployNuclearContract(
			&xfers,
			energi_params.Nuclear_MasternodeRegistryV1,
			nil,
		...
		panic("Nuclear Genesis V1 is not supported anymore")
	}
	deployNuclearContract(
		&xfers,
		energi_params.Nuclear_BlacklistRegistryV1,
		nil,
		energi_abi.BlacklistRegistryV1ABI,
		energi_abi.BlacklistRegistryV1Bin,
		energi_params.Nuclear_BlacklistRegistry,
		energi_params.Nuclear_MasternodeRegistry,
		energi_params.Nuclear_MigrationContract,
		energi_params.Nuclear_CompensationFundV1,
		config.Nuclear.EBISigner,
	)
	deployNuclearContract(
		&xfers,
		energi_params.Nuclear_CompensationFundV1,
	...
	deployNuclearContract(
		...
		energi_params.Nuclear_BlacklistRegistry,
		config.ChainID,
		config.Nuclear.MigrationSigner,
	)
	deployNuclearContract(
		&xfers,
		energi_params.Nuclear_Blacklist,
		nil,
	...
	deployNuclearContract(
		&xfers,
		energi_params.Nuclear_Whitelist,
		nil,
		energi_abi.DummyAccountABI,
		energi_abi.DummyAccountBin,
	)
	deployNuclearContract(
		&xfers,
		energi_params.Nuclear_MasternodeList,
		nil,
		energi_abi.DummyAccountABI,
		energi_abi.DummyAccountBin,
	)
	...
	proxies := map[common.Address]common.Address{
		energi_params.Nuclear_BlockReward:        energi_params.Nuclear_BlockRewardV1,
		energi_params.Nuclear_Treasury:           energi_params.Nuclear_TreasuryV1,
		energi_params.Nuclear_MasternodeRegistry: energi_params.Nuclear_MasternodeRegistryV1,
		energi_params.Nuclear_StakerReward:       energi_params.Nuclear_StakerRewardV1,
		energi_params.Nuclear_BackboneReward:     energi_params.Nuclear_BackboneRewardV1,
		energi_params.Nuclear_SporkRegistry:      energi_params.Nuclear_SporkRegistryV1,
		energi_params.Nuclear_CheckpointRegistry: energi_params.Nuclear_CheckpointRegistryV1,
		energi_params.Nuclear_BlacklistRegistry:  energi_params.Nuclear_BlacklistRegistryV1,
		energi_params.Nuclear_MasternodeToken:    energi_params.Nuclear_MasternodeTokenV1,
	}
