...
func TestPreBlacklist(t *testing.T) {
	...
	gspec.Config.Nuclear = &params.NuclearConfig{
		EBISigner: sender,
	}
	...
	propose1 := types.NewTransaction(
		1, energi_params.Nuclear_BlacklistRegistry, common.Big0, 1000000, common.Big0, propose1Call)
	propose2 := types.NewTransaction(
		2, energi_params.Nuclear_BlacklistRegistry, common.Big0, 1000000, common.Big0, propose2Call)
	proposeWL := types.NewTransaction(
		3, energi_params.Nuclear_BlacklistRegistry, common.Big0, 1000000, common.Big0, proposeWLCall)
	revoke := types.NewTransaction(
		4, energi_params.Nuclear_BlacklistRegistry, common.Big0, 1000000, common.Big0, revokeCall)
	proposePaid := types.NewTransaction(
		1, energi_params.Nuclear_BlacklistRegistry, common.Big0, 1000000, common.Big1, propose1Call)
