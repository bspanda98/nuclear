...
func TestZeroFeeProtectorMasternode(t *testing.T) {
	...
	hbtx0 := types.NewTransaction(
		1, energi_params.Nuclear_MasternodeRegistry, common.Big0, 100000, common.Big0, heartbeatCall)
	invtx0 := types.NewTransaction(
		1, energi_params.Nuclear_MasternodeRegistry, common.Big0, 100000, common.Big0, invalidateCall)
	sigtx0 := types.NewTransaction(
		1, energi_params.Nuclear_MasternodeRegistry, common.Big0, 100000, common.Big0, cpsignCall)
...
func TestZeroFeeProtectorMigration(t *testing.T) {
	...
	claim1 := types.NewTransaction(
		1, energi_params.Nuclear_MigrationContract, common.Big0, 100000, common.Big0, claim1Call)
	claim2 := types.NewTransaction(
		1, energi_params.Nuclear_MigrationContract, common.Big0, 100000, common.Big0, claim2Call)
