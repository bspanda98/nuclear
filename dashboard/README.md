## Nuclear Core Dashboard

The dashboard is a data visualizer integrated into nuclear, intended to collect and visualize useful information of an Nuclear node. It consists of two parts:
...
```
$ nuclear --dashboard --vmodule=dashboard=5
