			...
			<Grid container className={this.props.classes.footer} direction='row' alignItems='center' style={styles.footer}>
				...
				<Grid item >
					<Typography type='caption' color='inherit'>
						<span style={commonStyles.light}>Nuclear Core</span> {general.version}
					</Typography>
					{general.commit && (
						<Typography type='caption' color='inherit'>
							<span style={commonStyles.light}>{'Commit '}</span>
							<a href={`https://nuclear/core/nuclear/commit/${general.commit}`} target='_blank' style={{color: 'inherit', textDecoration: 'none'}} >
