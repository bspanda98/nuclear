...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "nuclear.ipc", false, filepath.Join(os.TempDir(), "nuclear.ipc")},
		{"data", "nuclear.ipc", false, "data/nuclear.ipc"},
		{"data", "./nuclear.ipc", false, "./nuclear.ipc"},
		{"data", "/nuclear.ipc", false, "/nuclear.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "nuclear.ipc", true, `\\.\pipe\nuclear.ipc`},
		{"data", "nuclear.ipc", true, `\\.\pipe\nuclear.ipc`},
		{"data", `\\.\pipe\nuclear.ipc`, true, `\\.\pipe\nuclear.ipc`},
	}
