...
func blacklistRegistry(
	...
	contract, err := energi_abi.NewIBlacklistRegistry(
		energi_params.Nuclear_BlacklistRegistry, backend.(bind.ContractBackend))
	if err != nil {
		return nil, err
	}
...
func (b *BlacklistAPI) blacklistInfo(num *big.Int) (interface{}, error) {
	registry, err := energi_abi.NewIBlacklistRegistryCaller(
		energi_params.Nuclear_BlacklistRegistry, b.backend.(bind.ContractCaller))
	if err != nil {
...
func (b *BlacklistAPI) compensationFundAddress() (common.Address, error) {
	contract, err := energi_abi.NewIBlacklistRegistry(
		energi_params.Nuclear_BlacklistRegistry, b.backend.(bind.ContractBackend))
	if err != nil {
