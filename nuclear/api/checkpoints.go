...
func (b *CheckpointAPI) registry(
	...
	contract, err := energi_abi.NewICheckpointRegistry(
		energi_params.Nuclear_CheckpointRegistry, b.backend.(bind.ContractBackend))
	if err != nil {
		return nil, nil, err
	}
...
func (b *CheckpointAPI) checkpointInfo(num *big.Int) (interface{}, error) {
	registry, err := energi_abi.NewICheckpointRegistryCaller(
		energi_params.Nuclear_CheckpointRegistry, b.backend.(bind.ContractCaller))
	if err != nil {
...
func (b *CheckpointAPI) CheckpointPropose(
	...
	registry, hashsig, err := b.registry(password, b.backend.ChainConfig().Nuclear.CPPSigner)
	if err != nil {
		return
	}
