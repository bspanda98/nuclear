...
func TestMasternodeList(t *testing.T) {
	...
	//---
	empty := common.Hash{}
	assert.True(t, blstate.GetState(energi_params.Nuclear_MasternodeList, mn_addr1.Hash()) != empty)
	assert.True(t, blstate.GetState(energi_params.Nuclear_MasternodeList, mn_addr2.Hash()) != empty)
	assert.True(t, blstate.GetState(energi_params.Nuclear_MasternodeList, owner_addr1.Hash()) == empty)
