 ...
 */
func (e *Nuclear) calcPoSModifier(
	chain ChainReader,
	time uint64,
	parent *types.Header,
) (ret common.Hash) {
 ...
 */
func (e *Nuclear) calcPoSDifficulty(
	chain ChainReader,
	time uint64,
	parent *types.Header,
	tt *timeTarget,
 ...
 * to start with.
 */
func (e *Nuclear) lookupStakeWeight(
	chain ChainReader,
	now uint64,
	till *types.Header,
	addr common.Address,
...
func (e *Nuclear) mine(
	...
	for _, a := range accounts {
		...
		if a == energi_params.Nuclear_MigrationContract {
			migration_dpos = true
		}
	}
