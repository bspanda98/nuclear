...
var (
	NuclearMainnetChainConfig = &ChainConfig{
	...
	NuclearTestnetChainConfig = &ChainConfig{
...
type ChainConfig struct {
	...
	Nuclear *NuclearConfig `json:"energi,omitempty"`
...
// NuclearConfig is the consensus engine config for proof-of-stake based sealing.
...
// String implements the stringer interface, returning the consensus engine details.
func (*NuclearConfig) String() string {
	return "energi"
}
