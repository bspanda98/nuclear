...
import (
	...
	ch "nuclear/core/nuclear/swarm/chunk"
	"nuclear/core/nuclear/swarm/shed"
...
//
// # go test -benchmem -run=none nuclear/core/nuclear/swarm/storage/localstore -bench BenchmarkNew -v -timeout 20m
// goos: darwin
// goarch: amd64
